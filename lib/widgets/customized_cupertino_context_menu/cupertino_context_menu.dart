...
// ignore_for_file: implementation_imports, deprecated_member_use_from_same_package, unnecessary_null_comparison
...
///
/// When open, the [CustomizedCupertinoContextMenu] shows the child, or the widget returned
...
class CustomizedCupertinoContextMenu extends StatefulWidget {
  /// Create a context menu.
  ///
  /// [actions] is required and cannot be null or empty.
  ///
  /// [child] is required and cannot be null.
  CustomizedCupertinoContextMenu({
    super.key,
  ...
  ///
  /// [builder] is required.
  CustomizedCupertinoContextMenu.builder({
    super.key,
    required this.actions,
  ...
  /// [CustomizedCupertinoContextMenu] is closed, when it is in the middle of opening,
  ...
  /// passed to the builder, using values exposed by [CustomizedCupertinoContextMenu],
  /// like [CustomizedCupertinoContextMenu.kEndBoxShadow], to match the native iOS
  ...
  /// The widget that can be "opened" with the [CustomizedCupertinoContextMenu].
  ///
  /// When the [CustomizedCupertinoContextMenu] is long-pressed, the menu will open and
  ...
  /// doesn't size itself.
  ///
  /// When the [CustomizedCupertinoContextMenu] is "closed", this widget acts like a
  ...
  /// [CustomizedCupertinoContextMenu] is open.
  ///
  ...
  @override
  State<CustomizedCupertinoContextMenu> createState() => _CustomizedCupertinoContextMenuState();
}

class _CustomizedCupertinoContextMenuState extends State<CustomizedCupertinoContextMenu> with TickerProviderStateMixin {
  ...
  final double _midpoint = CustomizedCupertinoContextMenu.animationOpensAt / 2;
  ...
  void initState() {
    ...
    _openController = AnimationController(
      ...
      vsync: this,
      upperBound: CustomizedCupertinoContextMenu.animationOpensAt,
    );
    ...
    _route = _ContextMenuRoute<void>(
      ...
      builder: (BuildContext context, Animation<double> animation) {
        if (widget.child == null) {
          final Animation<double> localAnimation = Tween<double>(begin: CustomizedCupertinoContextMenu.animationOpensAt, end: 1).animate(animation);
...
class _DecoyChildState extends State<_DecoyChild> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _boxDecoration = DecorationTween(
      ...
      curve: Interval(0.0, CustomizedCupertinoContextMenu.animationOpensAt),
    ),
    );
  }
